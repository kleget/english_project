...
# from main import print_all_files_from_rootdir
from text_analysis import analysand_func_dict
import re

# text = "Hello, World! 123_Привет@"

def print_all_files_from_rootdir(): # в get_txt_file нужно передавать название файла в месте папкой типа code/book.txt, а не просто book.txt
